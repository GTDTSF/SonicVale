...
class ChapterService:
    ...
    def create_chapter(self,  entity: ChapterEntity):
        ...
        max_order = self.repository.get_max_order_index(entity.project_id)
    ...
    def delete_chapter(self, chapter_id: int) -> bool:
        ...
        project_repository = ProjectRepository(self.repository.db)
        project = project_repository.get_by_id(chapter.project_id)
        chapter_path = os.path.join(get_project_root(project.folder_name), str(chapter.project_id), str(chapter.order_index))
